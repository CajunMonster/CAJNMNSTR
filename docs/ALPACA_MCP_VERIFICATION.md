...
- The official Alpaca MCP Server v2.3.0 is a locally registered, read-oriented AI/developer
...
- Server: `alpaca-mcp-server==2.3.0`
- Compatibility dependency: `fastmcp==3.1.0`, matching Alpaca's v2.3.0 lockfile
...
On 2026-09-01 at 06:08:42 UTC, `scripts/verify_alpaca_mcp_readonly.py`:

1. initialized the official v2.3.0 server through the same local launcher;
