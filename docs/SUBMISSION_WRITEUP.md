...
option snapshots, deterministic order handling, positions, and broker reconciliation. The Alpaca
MCP Server is restricted to read-oriented market toolsets and exposes no trading tools to the AI.
